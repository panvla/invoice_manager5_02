package com.vladimirpandurov.invoice_manager502.configuration;

import com.vladimirpandurov.invoice_manager502.filter.CustomAuthorizationFilter;
import com.vladimirpandurov.invoice_manager502.handler.CustomAccessDeniedHandler;
import com.vladimirpandurov.invoice_manager502.handler.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_URLS = {"/user/login/**", "/user/register/**", "/user/verify/code/**",
            "/user/resetpassword/**", "/user/verify/password/**", "/user/verify/password/**", "/user/verify/account/**", "/user/refresh/token/**"};
