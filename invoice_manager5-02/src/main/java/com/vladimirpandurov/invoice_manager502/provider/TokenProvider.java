package com.vladimirpandurov.invoice_manager502.provider;
...
public class TokenProvider {
    ...
    private static final String VLP_GROUP_LLC = "VLP_GROUP_LLC";
    private static final String SECURE_CAPITA = "SECURE_CAPITA";
    ...
    public String createAccessToken(UserPrincipal userPrincipal){
        return JWT.create()
                .withIssuer(VLP_GROUP_LLC)
                .withAudience(SECURE_CAPITA)
    ...
    private JWTVerifier getJWTVerifier(){
        ...
        try{
            ...
            verifier = JWT.require(algorithm).withIssuer(VLP_GROUP_LLC).build();
