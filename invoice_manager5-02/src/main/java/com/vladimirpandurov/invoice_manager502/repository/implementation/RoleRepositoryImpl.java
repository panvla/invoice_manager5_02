...
import com.vladimirpandurov.invoice_manager502.rowmapper.RoleRowMapper;
...
import static com.vladimirpandurov.invoice_manager502.query.RoleQuery.*;
...
public class RoleRepositoryImpl implements RoleRepository<Role> {
    ...
    public Role getRoleByUserId(Long userId) {
        try{
            Role role = jdbc.queryForObject(SELECT_ROLE_BY_USER_ID, Map.of("userId", userId), new RoleRowMapper());
            return role;
        }catch (EmptyResultDataAccessException exception){
